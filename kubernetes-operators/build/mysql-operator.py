...
def render_template(filename, vars_dict):
    ...
    json_manifest = yaml.full_load(yaml_manifest) # "yaml.load()" is deprecated, see https://github.com/yaml/pyyaml/wiki/PyYAML-yaml.load(input)-Deprecation
    return json_manifest

# I think this function is kind of redundant in Kubernetes v1.23 or higher because of the feature that introduces time-to-live field for completed jobs, 
